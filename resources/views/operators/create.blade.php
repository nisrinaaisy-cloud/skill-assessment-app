            ...
            <div class="operator-title-wrap">
                ...
                <div>
                    ...
                    <p class="operator-subtitle">
                        Tambahkan data operator baru ke sistem skill assessment.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nik') }}">
                        <div class="form-text">
                            NIK harus unik. Sistem akan menolak jika NIK sudah digunakan operator lain.
                        </div>
                        @error('nik')
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="leader_id"
                            ...
                            @foreach($leaders as $leader)
                                <option value="{{ $leader->employee->id }}"
                                        data-divisi="{{ $leader->divisi_id }}"
                                        {{ old('leader_id') == $leader->employee->id ? 'selected' : '' }}>
                                    {{ $leader->employee->nama_lengkap }}
                                </option>
                            @endforeach
                        </select>
                        <div class="form-text">
        ...
        <div class="modal-content rounded-4 border-0 shadow">
            <div class="modal-body text-center p-4">
                ...
                <p class="text-muted mb-4" style="font-size: 14px;">
                    Pastikan nama, NIK, divisi, dan leader sudah benar sebelum data disimpan.
                </p>
