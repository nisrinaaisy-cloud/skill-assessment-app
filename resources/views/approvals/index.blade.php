          ...
          <tbody>
            @forelse($approvals as $approval)
              @php
                ...
                $foremanClass = $approval->status_foreman === 'approved' ? 'status-approved' : 'status-pending';

                $kabagClass = $approval->status_kabag === 'approved' ? 'status-approved' : 'status-pending';
              @endphp
              <tr>
                ...
                <td>
                  <a href="{{ route('approvals.show', $approval->id) }}" class="btn-action-detail"
